{
  unify.modules.niri.home = {config, ...}: {
    programs.niri.settings.binds = with config.lib.niri.actions; {
      ...
      "Mod+WheelScrollDown" = {
        action = focus-workspace-down; # nix: Mod+WheelScrollDown      cooldown-ms=150 { focus-workspace-down; }
        cooldown-ms = 150;
      };
      "Mod+WheelScrollUp" = {
        action = focus-workspace-up; # nix: Mod+WheelScrollUp        cooldown-ms=150 { focus-workspace-up; }
        cooldown-ms = 150;
      };
      "Mod+Ctrl+WheelScrollDown" = {
        action = move-column-to-workspace-down; # nix: Mod+Ctrl+WheelScrollDown cooldown-ms=150 { move-column-to-workspace-down; }
        cooldown-ms = 150;
      };
      "Mod+Ctrl+WheelScrollUp" = {
        action = move-column-to-workspace-up; # nix: Mod+Ctrl+WheelScrollUp   cooldown-ms=150 { move-column-to-workspace-up; }
        cooldown-ms = 150;
      };
